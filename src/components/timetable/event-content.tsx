...
export default function EventContent(eventInfo: TEventInfo) {
    return (
        ...
        >
            <p className="max-h-1/2 w-full overflow-hidden text-ellipsis text-center align-bottom text-[0.5rem]/[0.5rem] font-bold">
                {eventInfo.event.title}
            </p>
            <p className="max-h-1/2 w-full overflow-hidden text-ellipsis text-center align-top text-[0.5rem]/[0.5rem]">
