...
class Bucket {
     ...
     */
    public async uploadFile(file: File): Promise<{ success: boolean, data: BucketUploadOutputData }> {
     ...
     */
    public async deleteFileByName(fileName: string): Promise<{ success: boolean, data: BucketUploadOutputData }> {
     ...
     * @returns {Promise<{success: boolean, data: BucketUploadOutputData}>}
     */
    public async deleteFileById(fileId: string): Promise<{ success: boolean, data: BucketUploadOutputData }> {
